...
public class SeamCarving{
	...
	public SeamCarving(String nomFichier, float percentHeight, float percentWidth){

		this.image = image(nomFichier);
		this.width = this.image.getWidth();
		this.height = this.image.getHeight();
		int horizontalNumber = (int) ( ((float) this.height / 100.0) * percentHeight);
		int verticalNumber  = (int) ( ((float) this.width / 100.0) * percentWidth);
		getEnergyTab();

		//extractEnergy();								//Permet d'enregistrer une image de l'energie
		//extractHorizontale(findHorizontalSeam());		//Permet d'enregistrer une image avec une 'ligne' horizontale
		//extractVertical(findVerticalSeam());			//Permet d'enregistrer une image avec une 'ligne' verticale
